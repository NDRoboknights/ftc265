...
public class ExtendedKalmanFilter<States extends Num, Inputs extends Num, Outputs extends Num>
  ...
  public ExtendedKalmanFilter(
    ...
    final Pair<Matrix<States, States>, Matrix<States, States>> discPair = Discretization.discretizeAQTaylor(contA, m_contQ, dtSeconds);
  ...
  public void predict(
      ...
      double dtSeconds) {
    // Find continuous A
    final Matrix contA = NumericalJacobian.numericalJacobianX(m_states, m_states, f, m_xHat, u);
