 ...
 * rotation for inverse kinematics is also doubleiable. This means that you can set your set your
 ...
 * system (more equations than doubleiables), we use a least-squares approximation.
 *
...
public class MecanumDriveKinematics {
     ...
     *
     * <p>This function also supports doubleiable centers of rotation. During normal operations, the
