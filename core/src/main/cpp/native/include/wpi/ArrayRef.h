...
/*implicit*/ MutableArrayRef(SmallVectorImpl<T>
&Vec)
:
ArrayRef<T>(Vec) {}

/// Construct a MutableArrayRef from a std::vector.
/*implicit*/ MutableArrayRef(std::vector<T>
&Vec)
:
ArrayRef<T>(Vec) {}
...
/// Construct an ArrayRef from a std::array
template<size_t N>
/*implicit*/ constexpr MutableArrayRef(std::array<T, N>
&Arr)
:
ArrayRef<T>(Arr) {}
...
template<size_t N>
/*implicit*/ constexpr MutableArrayRef(T(&Arr)
[N]) :
ArrayRef<T>(Arr) {}
