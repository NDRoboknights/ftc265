...
/// for usage.
    ...
    private:
        ...
        struct IsInnerUnion {
            ...
            int is() const {
                return Val.template is<InnerUnion>() &&
                       Val.template get<InnerUnion>().
                               template is<T>();
            }

            template<typename T>
            T get() const {
                return Val.template get<InnerUnion>().
                        template get<T>();
            }
        };
        ...
        struct IsPT3 {
            ...
            template<typename T>
            int is() const { return Val.template is<T>(); }

            template<typename T>
            T get() const { return Val.template get<T>(); }
        };
        ...
        int is() const {
            ...
            using Ty = typename ::wpi::PointerUnionTypeSelector<
                    ...
                    ::wpi::PointerUnionTypeSelector<PT2, T, InnerUnion1,
                            InnerUnion2>>::Return;
            return Val.template is<Ty>() && Val.template get<Ty>().
                    template is<T>();
        }
